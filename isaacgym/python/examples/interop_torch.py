...
print('compute_device_id', args.compute_device_id)
graphics_device_id = args.compute_device_id
...
use_viewer = False # ZL: disable viewer
...
for i in range(num_envs):
    ...
    print("Created camera sensor %d" % cam_handle)
    ...
    # if i == 0:
    #     # record video
    #     envs[i] = RecordVideo(envs[0], "interop_video")
    #     envs[i].is_vector_env = True
