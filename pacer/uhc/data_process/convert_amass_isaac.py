...
def run(in_file: str, out_file: str):
    ...
    for key_name in tqdm(amass_data.keys()):
        ...
        for idx in range(num):
            ...
            smpl_local_robot.write_xml("pacer/data/assets/mjcf/smpl_humanoid_1.xml")
            skeleton_tree = SkeletonTree.from_mjcf("pacer/data/assets/mjcf/smpl_humanoid_1.xml")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_file", type=str, default="data/amass/pkls/amass_copycat_take5_train.pkl")
