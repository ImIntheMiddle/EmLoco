...
class Robot:
    ...
    def load_from_skeleton(
        ...
        if self.mesh:
            ...
            # self.model_dirs.append(f"pacer/data/assets/mesh/smpl/{uuid.uuid4()}")
...
if __name__ == "__main__":
    ...
    smpl_robot.write_xml(f"pacer/data/assets/mjcf/smpl_humanoid.xml")
    m = mujoco.MjModel.from_xml_path(f"pacer/data/assets/mjcf/smpl_humanoid.xml")
    d = mujoco.MjData(m)
