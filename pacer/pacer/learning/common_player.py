...
class CommonPlayer(players.PpoPlayerContinuous):
    ...
    def run(self):
        ...
        for t in range(n_games):
            ...
            with torch.no_grad():
                # show progress bar
                bar = tqdm.tqdm(total=self.max_steps, desc='steps', leave=False)
    ...
    def env_save_video(self, game, exp_name, rew, real_traj, ideal_traj): # added by takez
        done = self.env.save_video(game, exp_name, rew, real_traj, ideal_traj)
        return done
