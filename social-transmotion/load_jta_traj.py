...
def save_to_pkl(traj_dict, dataset_name, split):
    ...
    save_path = os.path.join(save_dir, f'{dataset_name[0]}_{split}_trajs.pkl')
    with open(save_path, 'wb') as f:
        pickle.dump(traj_dict, f)

def get_primary_init_pose_jta(joints):
    return joints[:, 0, 8, 3:27, :3]
...
if __name__ == "__main__":
    ...
    main(cfg, logger, experiment_name='save_trajs', dataset_name=dataset, f_init_pose=get_primary_init_pose_jta)
