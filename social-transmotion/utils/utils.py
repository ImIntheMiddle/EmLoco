...
def init_output_dirs(exp_name="default", dataset_name="default"):
    log_dir = path_to_experiment(dataset_name, exp_name)
...
def load_config(path, exp_name="default", dataset_name="default"):
    """
    ...
    if "OUTPUT" not in config:
        config["OUTPUT"] = {}
    config["OUTPUT"]["log_dir"], config["OUTPUT"]["ckpt_dir"], config["OUTPUT"]["runs_dir"] = init_output_dirs(exp_name=exp_name, dataset_name=dataset_name)
