...
def main(opt):
    ...
    sequence = {
        ...
        "val": ["gates-ai-lab-2019-02-08_0"],
        "test": ["packard-poster-session-2019-03-20_1", "tressider-2019-03-16_0"],
    }
    ...
    for part, data in datalist:
        ...
        for scene_id, scene in enumerate(part_loader):
            ...
            for person_id, person in enumerate(scene):
                ...
                assert scene_name in posedict, (
                    f"{scene_name} is not in {posedict.keys()}"
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--hst_dir",
        type=str,
        default="data/jrdb/hst_labels",
        help="Directory of the HST dataset.",
    )
